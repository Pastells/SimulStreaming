...
from .whisper.decoding import BeamSearchDecoder, GreedyDecoder, SuppressTokens, detect_language
        ...
        language_probs = [
            {
                ...
                for j, c in zip(
                    self.tokenizer.all_language_tokens, self.tokenizer.all_language_codes
                )
            }
